...
This was our final version of the program to create the image "van3" (which you can find in the 
the Web Comparison Tool) which many cars, drawn at different positions and of different sizes.  To 
create this output, we created a parameterized method that could draw the car at the given location 
(via x, y coordinate parameters) and with a given size. 
*/
